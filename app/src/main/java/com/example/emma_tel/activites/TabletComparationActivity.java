...
public class TabletComparationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tablet_comparation);
        tablet =(Tablet) getIntent().getSerializableExtra("first");
        tablet2 =(Tablet) getIntent().getSerializableExtra("second");
    ...
    private  void assignUIReferenceMobile1()
    {
        ...
        Picasso.with(this).load(Constants.IMG_URL+tablet.getImage()).into(mobileImage);
        mobilePrice = findViewById(R.id.text_view_mobile_price);
        mobilePrice.setText(tablet.getPrice() +" "+getResources().getString(R.string.sp));
        mobilePrice2 = findViewById(R.id.text_view_mobile_price2);
        mobilePrice2.setText(tablet2.getPrice() +" "+getResources().getString(R.string.sp));
    ...
    private  void assignUIReferenceMobile2()
    {
        ...
        Picasso.with(this).load(Constants.IMG_URL+tablet2.getImage()).into(mobileImage2);

        mobileTitle2.setText(tablet2.getName());
        cpuText2.setText(tablet2.getCpu());
        ramText2.setText(tablet2.getRam());
        screenText2.setText(tablet2.getScreen());
        networkText2.setText(tablet2.getNetworks());
        cameraText2.setText(tablet2.getMain_camera());
        frontCameraText2.setText(tablet2.getFront_camera());
        batteryText2.setText(tablet2.getBattery());
        storageText2.setText(tablet2.getInternal_storage());
        detailsText2.setText(tablet2.getOther_details());


        String[] colors = tablet2.getColors().split(";");
        for (int i =0 ;i<colors.length;i++)
        {
            LinearLayout color = new LinearLayout(this);
            color.setBackgroundColor(Color.parseColor(colors[i]));
